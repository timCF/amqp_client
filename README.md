...
It's meant to be included in your rebar projects in your rebar.config file:
		...
		{deps, [
			{amqp_client, ".*", {git, "git://github.com/synlay/amqp_client.git", {tag, "rabbitmq-2.8.7"}}}
		]}.
...
to the version tag:
		...
		{deps, [
			{amqp_client, ".*", {git, "git://github.com/synlay/amqp_client.git", {tag, "rabbitmq-2.8.7-community"}}}
		]}.
