...
It's meant to be included in your rebar projects in your rebar.config file:
		...
		{deps, [
			{amqp_client, ".*", {git, "git://github.com/jbrisbin/amqp_client.git", {tag, "rabbitmq-3.1.0"}}}
		]}.
...
to the version tag:
		...
		{deps, [
			{amqp_client, ".*", {git, "git://github.com/jbrisbin/amqp_client.git", {tag, "rabbitmq-community"}}}
		]}.
